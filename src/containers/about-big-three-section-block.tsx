...
const artSections = [
  ...
  },
  {
    ...
    // path: "/assets/images/tshirts/white-tshirt-male-picasso-like.png",
    path: "/assets/images/tshirts/white-tshirt-female-charcoal-flowers.png",
    path: "/assets/images/tshirts/white-tshirt-male-mountains.png",
  ...
  {
    path: "/assets/images/wall-art/og-wall-art-77-of-9.png",
    alt: "Young adults, store employees showcasing fashionable white printed t-shirts, within an aesthetically appealing boutique adorned with warm, inviting lighting.",
    width: 1920,
    height: 1920,
    hasPictureFrame: true,
  },
  {
    ...
    // path: "/assets/images/tshirts/white-tshirt-female-lavender-flowers.png",
    path: "/assets/images/tshirts/white-tshirt-female-standing-charcoal-mountains-and-trees.png",
...
const BigThreeSectionBlock: React.FC<BannerProps> = ({
  className = "mt-2",
}) => {
  return (
    <div
    ...
    >
      <div className="flex flex-col">
        ...
        {/* Box 2 and Box 3: Equal width */}
        <section className="flex flex-row flex-wrap lg:flex-nowrap h-2/3 gap-x-1 my-1">
          <div className="order-3 lg:order-2 w-full lg:w-1/2 h-full">
            <Image
          ...
          <div className="order-2 lg:order-3 w-full lg:w-1/2 h-full pb-1 lg:pb-0">
            {/* Using CSS Grid here for the 3x3 layout */}
            <div className="grid grid-cols-3 gap-2 w-full  h-full bg-[#607270] p-4">
...
export default BigThreeSectionBlock;
