    ...
    menu: [
      ...
      // },
      {
        ...
        subMenu: [
          ...
          {
            id: 2,
            path: "/search?category=bags-totes",
            label: "Bags & Totes",
          },
          {
            id: 3,
            path: "/search?category=cases",
          ...
          {
            id: 6,
            path: "/search?category=mugs-tumblers",
            label: "Mugs & Tumblers",
          },
          {
            id: 7,
            path: "/search?category=stationary",
            label: "Stationary",
          },
          {
            id: 8,
            path: "/search?category=stickers",
            label: "Stickers",
          },
          // {
          //   id: 9,
      ...
      },
      {
        ...
        subMenu: [
          ...
          {
            id: 1,
            path: "/search?category=art",
            label: "All Art",
          },
          {
            id: 2,
            path: "/search?category=original-art",
            label: "Original Pieces",
          },
          {
            id: 3,
            path: "/search?category=canvas",
            label: "Canvas",
          },
          {
            id: 4,
            path: "/search?category=photo-print",
            label: "Photo Prints",
          },
          // {
          //   id: 4,
