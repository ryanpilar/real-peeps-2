...
export const siteSettings = {
  ...
  logo: {
    ...
    alt: "Real Peeps Art & Clothing Studio",
    href: "/",
    width: 200,
    height: 45,
  },
    ...
    menu: [
...

      {
        ...
        subMenu: [
          ...
          // {
          //   id: 3,
          //   path: "/search?category=kids",
          //   label: "Kids",
          // },
          // {
          //   id: 4,
          //   path: "/search?category=baby",
          //   label: "Baby",
          // },
        ],
      },
      ...
      // },
      {
        ...
        subMenu: [
          ...
          {
            id: 2,
            path: "/products?category=bags-totes",
            label: "Bags & Totes",
          },
          {
            id: 3,
            path: "/products?category=cases",
            label: "Protective Cases",
          },
          // {
          //   id: 4,
          //   path: "/terms",
          //   label: "Laptop Protective Sleeve",
          // },
          // {
          //   id: 5,
          //   path: "/contact-us",
          ...
          {
            id: 6,
            path: "/products?category=mugs-tumblers",
            label: "Mugs & Tumblers",
          },
          {
            id: 7,
            path: "/products?category=stationary",
            label: "Stationary",
          },
          {
            id: 8,
            path: "/products?category=stickers",
            label: "Stickers",
          },
          // {
          //   id: 9,
      ...
      },
      {
        ...
        subMenu: [
          ...
          {
            id: 2,
            path: "/products?category=original-art",
            label: "Original Pieces",
          },
          {
            id: 3,
            path: "/products?category=canvas",
            label: "Canvas",
          },
          {
            id: 4,
            path: "/products?category=photo-print",
            label: "Photo Prints",
          },
          // {
          //   id: 4,
