  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className={`font-semibold text-sm sm:text-base mt-1.5 space-s-2 ${variant === "grid"
        ...
        >
          <span className={`inline-block ${demoVariant === "ancient" && "font-bold text-gray-900 text-lg"}`}>
            {price}
          </span>

          {discount && (
            <del className={`sm:text-base font-normal ${bgTransparent ? "text-white/70" : "text-gray-800"}`}>
              {basePrice}
            </del>
          )}
