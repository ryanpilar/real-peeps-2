...
const Subscription: React.FC<Props> = ({
  className = `
    sm:ps-16
    px-5 sm:px-8 md:px-16 2xl:px-24
  ...
  return (
    <div
      className={`
        ${className} 
        flex flex-col 2xl:flex-row justify-center 2xl:justify-between 
    ...
    >
      ...
      >
        <Text
          ...
          className="
            sm:mb-0 md:mb-2.5 lg:mb-3 xl:mb-3.5
            "
        >
          {t(`${title}`)}
        </Text>
      ...
      <form
        ...
        className="flex-shrink-0 sm:w-96 md:w-[545px] "
        noValidate
      >
        <div className="flex flex-col md:flex-row  justify-end ">
          ...
          <Button
            disableBorderRadius={disableBorderRadius}
            className="mt-3 w-full sm:mt-3 md:mt-0 sm:w-auto sm:ms-2 md:h-full flex-shrink-0"
          >
