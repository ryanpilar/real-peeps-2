...
export const homeThreeMasonryBanner = [
  {
    ...
    image: {
      mobile: {
        url: "/assets/images/banner/masonry/banner-mobile-1-mens.jpg",
        width: 470,
        height: 232,
      },
      desktop: {
        url: "/assets/images/banner/masonry/banner-1-mens.jpg",
        width: 1078,
        height: 425,
      },
    },
  ...
  },
  {
    ...
    image: {
      mobile: {
        url: "/assets/images/banner/masonry/banner-2-brown-tile.jpg",
        width: 232,
        height: 232,
      },
      desktop: {
  ...
  },
  {
    ...
    image: {
      mobile: {
        url: "/assets/images/banner/masonry/banner-3-art.jpg",
        width: 232,
        height: 232,
      },
      desktop: {
  ...
  {
    id: 4,
    title: "teal coloured mountains",
    slug: "",
    image: {
      mobile: {
        url: "/assets/images/banner/masonry/banner-4-teal-mountains.jpg",
        width: 232,
        height: 232,
      },
      desktop: {
  ...
  },
  {
    ...
    image: {
      mobile: {
        url: "/assets/images/banner/masonry/banner-4-blue-steel.jpg",
        width: 232,
        height: 232,
      },
      desktop: {
  ...
  },
  {
    ...
    image: {
      mobile: {
        url: "/assets/images/banner/masonry/banner-mobile-6-womans.jpg",
        width: 470,
        height: 232,
      },
      desktop: {
        url: "/assets/images/banner/masonry/banner-6-womans.jpg",
        width: 1078,
        height: 425,
      },
    },
...
export const contemporaryBanner1 = {
  ...
  image: {
    ...
    desktop: {
      url: "/assets/images/banner/banner-11.jpg",
      width: 1800,
      height: 600,
    },
  },
...
export const contemporaryBanner3 = {
  ...
  image: {
    ...
    desktop: {
      url: "/assets/images/banner/banner-13.png",
      width: 1800,
      height: 480,
    },
  },
